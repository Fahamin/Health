package com.workout.healthmanager.alarm.alarmmanagerdemo;
...
import com.workout.healthmanager.receiver.BootReceiver;
...
public class AlarmHelper {
    ...
    public AlarmHelper(Context context2) {
        ...
        this.alarmManager = (AlarmManager) context2.getSystemService(Context.ALARM_SERVICE);
    ...
    private PendingIntent getPendingIntent() {
        ...
        return PendingIntent.getBroadcast(this.context, getNextRequestCode(), intent, flag);
    }
    ...
    public PendingIntent existAlarm(int i) {
        Intent intent = new Intent("com.crazytrends.healthmanager.alarmmanagerdemo.NOTIFY_ACTION");
        intent.setClass(this.context, NotificationPublisher.class);
        return PendingIntent.getBroadcast(this.context, i, intent, flag);
    }

    public boolean isAlarmScheduled(int i) {
        Intent intent = new Intent("com.crazytrends.healthmanager.alarmmanagerdemo.NOTIFY_ACTION");
        intent.setClass(this.context, NotificationPublisher.class);
        return PendingIntent.getBroadcast(this.context, i, intent, flag) != null;
    }
