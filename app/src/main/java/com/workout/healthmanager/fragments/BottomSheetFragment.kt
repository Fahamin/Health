package com.workout.healthmanager.fragments
...
import com.workout.healthmanager.helpers.AlarmHelper
...
class BottomSheetFragment(val mCtx: Context) : BottomSheetDialogFragment() {
    ...
    @RequiresApi(Build.VERSION_CODES.TIRAMISU)
    var rintonLuncher = registerForActivityResult<Intent, ActivityResult>(
