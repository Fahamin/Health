package com.workout.healthmanager.general;
...
import com.workout.healthmanager.BMR.bmr_calculator;
import com.workout.healthmanager.Body_Surface_Area_Calculator.C1376Body_Surface_Area_Calculator;
import com.workout.healthmanager.R;
import com.workout.healthmanager.alcohol.Alcohol_Calculator;
import com.workout.healthmanager.blood_donation.Blood_Donation_Calculator;
import com.workout.healthmanager.blood_pressure.BloodPressure_Calculator;
import com.workout.healthmanager.blood_volume.Blood_Volume_Calculator;
import com.workout.healthmanager.bmi.BMI_Calculator;
import com.workout.healthmanager.body_adiposity_index.Body_Adiposity_Index_Calculator;
import com.workout.healthmanager.body_fat.Bodyfat_Calculator;
import com.workout.healthmanager.body_frame_size.Body_Frame_Size_Calculator;
import com.workout.healthmanager.calories_burn.Calories_burn_Calculator;
import com.workout.healthmanager.calories_intake.Daily_Calories_Intake_Calculator;
import com.workout.healthmanager.chest_hip_ratio.Chest_Hip_Ratio_Calculator;
import com.workout.healthmanager.child_growth.Child_Growth_Calculator;
import com.workout.healthmanager.children_height_growth.Children_Height_Growth_Prediction_Calculator;
import com.workout.healthmanager.cholestrol.Cholestrol_Calculator;
import com.workout.healthmanager.daily_water.Daily_WaterIntake_Calculator;
import com.workout.healthmanager.heart_rate.Heart_Rate_Calculator;
import com.workout.healthmanager.ideal_body_weight.Ideal_Body_Weight_Calculator;
import com.workout.healthmanager.lean_body_mass.Lean_Body_Mass_Calculator;
import com.workout.healthmanager.menstrual_and_ovulation.Menstrual_Ovulation_Calculator;
import com.workout.healthmanager.pregnancy_due_date.Pregnancy_Due_Date_Calculator;
import com.workout.healthmanager.smoking_risk.Smoking_Risk_Calculator;
import com.workout.healthmanager.sugar.Sugar_calculator;
import com.workout.healthmanager.trademill.Trademill_Calculator;
import com.workout.healthmanager.utils.TypefaceManager;
import com.workout.healthmanager.waist_height_ratio.Waist_Height_Ratio_Calculator;
import com.workout.healthmanager.waist_hip_ratio.Waist_Hip_Ratio_Calculator;
...
//            gradientDrawable.setColor(Color.parseColor(sb.toString()));
            ...
            myRestaurant_ViewHolder.rl_home.setOnClickListener(new OnClickListener() {
                public void onClick(View view) {
                    ...
                    if (i == 0) {
                        Intent intent = new Intent(activity, bmr_calculator.class);
